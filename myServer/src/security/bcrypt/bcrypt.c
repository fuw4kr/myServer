...
static int get_random_bytes(char *out, size_t count)
{
#ifdef _WIN32
	NTSTATUS status = BCryptGenRandom(NULL, (PUCHAR)out, (ULONG)count, BCRYPT_USE_SYSTEM_PREFERRED_RNG);
